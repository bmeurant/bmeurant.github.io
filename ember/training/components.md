...
logiques au sein d'une application. Voire, via le packaging de ces composants au sein d'[addons](https://guides.emberjs.com/v2.9.0/addons-and-dependencies/managing-dependencies/#toc_addons), 
...
est disponible dans la [documentation officielle](https://guides.emberjs.com/v2.9.0/components/handling-events/#toc_event-names). 

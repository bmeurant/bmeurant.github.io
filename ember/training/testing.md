...
[documentation officielle](https://guides.emberjs.com/v2.10.0/testing/acceptance/).
...
[documentation officielle](https://guides.emberjs.com/v2.10.0/testing/unit-testing-basics/).
...
Depuis l'ajout d'[Ember Data](https://guides.emberjs.com/v2.10.0/models/), les tests ne passent plus, conséquence des nombreux changements

...
la commande ``ember generate helper helper-name`` ou la contribution directe dans le dossier ``app/helpers``. cf [Ember documentation](http://guides.emberjs.com/v2.10.0/templates/writing-helpers/) & 
...
1. Via la console, accéder à l'objet `comics` et ajouter un élément à la liste.
    ...
    * Puis la méthode `pushObject` d' [Ember](http://emberjs.com) : [pushObject](http://emberjs.com/api/classes/Ember.MutableArray.html#method_pushObject)
    ...
    > cf. [documentation](http://guides.emberjs.com/v2.10.0/configuring-ember/disabling-prototype-extensions/)
